...
$message =  '<div style="padding: 64px; background-color: #f9f9f9; max-width: 480px; margin: 0 auto; text-align: center;">'.
            '<p style="color: #666; font-size: 16px;"><strong>Somebody wants to contact you!</strong></p>'.
            '<p style="color: #666; font-size: 16px;"><strong>Name:</strong> '.$_REQUEST['name'].'</p>'.
            '<p style="color: #666; font-size: 16px;"><strong>Company:</strong> '.$_REQUEST['company'].'</p>'.
            '<p style="color: #666; font-size: 16px;"><strong>Comment:</strong> '.$_REQUEST['comment'].'</p>'.
            '</div>';
